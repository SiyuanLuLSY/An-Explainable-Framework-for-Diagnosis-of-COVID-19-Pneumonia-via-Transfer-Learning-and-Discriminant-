function [FP,FN,TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY,TVT] = elm_kernel(train_data,test_data,Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
%%%%%%%%%% Calculate training & testing accuracy (RMSE) for regression case
    ...
    TestingAccuracy=sqrt(mse(TVT - TY));     
end
