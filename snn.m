function [TY,FP,FN,TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = snn(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
